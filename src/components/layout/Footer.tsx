	...
	return (
		<footer
			style={{
				...
				background:
					"linear-gradient(to right, transparent, color-mix(in srgb, var(--color-text) 16%, transparent) 48px, color-mix(in srgb, var(--color-text) 16%, transparent) calc(100% - 48px), transparent) no-repeat top / 100% 1px, #22265a",
			}}
		>
