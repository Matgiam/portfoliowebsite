	...
	return (
		...
		>
			<div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
				<span style={{ fontFamily: "var(--font-heading)", fontWeight: 500, fontSize: "clamp(20px,2.2vw,34px)", letterSpacing: "-0.02em" }}>
					{title}
				</span>
	...
	return (
		...
		>
			...
			<SkillRow title="Front-end" level="Daily">
				...
				<SkillPill icon="/assets/icons/nextjs.png" label="Next.js" />
			...
			<SkillRow title="Data & tooling" level="Comfortable">
				...
				<SkillPill icon="/assets/icons/supabase.png" label="Supabase" />
